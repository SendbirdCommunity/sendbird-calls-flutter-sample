...
//    private var directCall: DirectCall? = null
    ...
    override fun configureFlutterEngine(@NonNull flutterEngine: FlutterEngine) {
        ...
        // Setup
        SendbirdPlatformChannels.Companion.setupChannels(this, flutterEngine.dartExecutor.binaryMessenger)
    }

    override fun onDestroy() {
        SendbirdPlatformChannels.Companion.disposeChannels()
        super.onDestroy()
    }
...
//
//            SendBirdCall.registerPushToken("AAAAlZmkNq8:APA91bGDF2KKMjGaUBn1785XHTpXP5fequWw9QQNRurQY3QNmpTE2uOiqQvKuB9anPXD9EAB6mL3Anj3oUBww6pE_cQiXTW5ZEyLo3LuicCZTpslqLNSgh9lzr_Ka_EEjGpXf5yVgvlw", true, object : CompletionHandler {
